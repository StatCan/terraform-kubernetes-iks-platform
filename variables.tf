...
variable "kubernetes_rbac_users" {
  type = "list"
  description = "Kubernetes RBAC Users binding to use for this Managed Kubernetes Cluster"
  default = []
}

variable "kubernetes_rbac_groups" {
  type = "list"
  description = "Kubernetes RBAC Groups binding to use for this Managed Kubernetes Cluster"
  default = []
}
